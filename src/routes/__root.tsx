...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AUREVA Estates — Exceptional Homes. Extraordinary Living." },
      {
        name: "description",
        content:
          "AUREVA Estates curates the finest waterfront residences, penthouses and private villas across Lagos, Nigeria.",
      },
      { name: "author", content: "AUREVA Estates" },
      { property: "og:title", content: "AUREVA Estates — Exceptional Homes. Extraordinary Living." },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,320;0,9..144,420;0,9..144,500;0,9..144,600;1,9..144,420&family=Instrument+Sans:wght@400;500;600&family=IBM+Plex+Mono:wght@400;500&display=swap",
      },
    ],
  }),
